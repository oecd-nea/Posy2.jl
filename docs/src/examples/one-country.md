...
makeintermittentsource("Onshore wind", electricity, snapshot; co2_node=co2, tech_column="Onwind", cap=800.0, weather_year=2019)
makedispatchable("CCGT", electricity, snapshot; co2_node=co2, maxcap=2_000.0, unit_size=0.0)
