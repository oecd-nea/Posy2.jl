...
makedispatchable(
    "Coal", electricity, snapshot; co2_node=emissions, tech_column="Coal",
    maxcap=2_000.0,
...
makedispatchable(
    "Gas", electricity, snapshot; co2_node=emissions, tech_column="CCGT",
    maxcap=2_000.0,
...
makenuclear(
    "Nuclear", electricity, snapshot; co2_node=emissions, tech_column="Nuclear",
    maxcap=2_000.0,
