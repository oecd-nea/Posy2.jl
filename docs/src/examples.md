...
| [Phase-Shifting Transformer](examples/phase-shift.md) | How an optional PST on one AC line cheapens dispatch in a three-zone DC OPF |
...
| [Phase-Shifting Transformer](examples/phase-shift.md) | `:arguments` | `:arguments` |
