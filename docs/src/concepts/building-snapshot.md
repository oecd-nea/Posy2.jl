...
```julia
makeintermittentsource("PV", grid, snapshot; co2_node=co2, tech_column="PV", cap=first_result)
```
...
```julia
makedispatchable("Gas", electricity, snapshot; co2_node=co2_node, tech_column="CCGT")
